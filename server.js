...
var guildId = "1231748598283108413"; // Guild ID for a Discord Server, see https://faxes.zone/i/zjKnd.png
var botToken = "MTIzMjM5NTA1NjczNjg5OTE1NQ.G8nFKY.Lq72ftOhinhlA0qemdHsueqIF-w4QoWep-RndA"; // This must be a Discord bot token, create a bot @ https://discord.com/developers/applications

var whitelistRoles = [ // Roles by ID that are whitelisted.
    "1231748924784775199", "1231748766919426099", "1231748814998732830"
];
var blacklistRoles = [ // Roles by Id that are blacklisted.
    "1231748989943021578", "1231748988395454564"
];

var notWhitelistedMessage = "عضويتك غير مفعلة في هذا السيرفر'";
...
// Time System //
var enableTime = true; // allowed free-access but only for a certain time
...
RegisterCommand('Whitelist', (source, args, raw) => {
        if (source == 0) {
            switch (args[0]) {
                ...
                default:
                    console.log("The argument is not valid please put 1 or 0");
            }
        } else {
